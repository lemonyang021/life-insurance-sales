...
public class ChannelController {
    ...
    Result<Long> register(@RequestBody @Validated RegisterChannelRequest request) {
        ...
        Long channelId = service.register(ConvertUtil.convert(request, ChannelBO.class));
    ...
    public @ResponseBody
    Result<ChannelResponse> get(@PathVariable("channelId") @Schema(title = "渠道id") @NotBlank(message = "渠道id不能为空") @NotNull(message = "渠道id不能为空") Long channelId) {
