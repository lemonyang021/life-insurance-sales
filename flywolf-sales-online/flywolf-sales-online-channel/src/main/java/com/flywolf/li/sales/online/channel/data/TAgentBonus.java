...
@Data
@Entity
@Table(name = "T_AGENT_BONUS")
@EqualsAndHashCode(callSuper = true)
public class TAgentBonus extends ExtendableAuditEntity implements Serializable {
    ...
    /**
     * [201809][Bonus Enhancement]Identifier Of adjustment type
     */
    @Column(name = "REMARK")
    private String REMARK;

    /**
     * [201810][Bonus Enhancement]Current Manager’s Override
     */
    @Column(name = "CUR_MO")
