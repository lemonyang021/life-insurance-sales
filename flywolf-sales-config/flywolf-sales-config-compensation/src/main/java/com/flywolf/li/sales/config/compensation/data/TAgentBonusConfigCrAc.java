...
/**
 * test table for CR AC, same with t_agent_bonus_config
 */
@Data
@Entity
@EqualsAndHashCode(callSuper = true)
@Table(name = "T_AGENT_BONUS_CONFIG_CR_AC")
public class TAgentBonusConfigCrAc extends ExtendableAuditEntity implements Serializable {
